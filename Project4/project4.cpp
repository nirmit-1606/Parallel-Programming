...
{
    // fprintf(stderr, "Arraysize, Non-SIMD Mul, SIMD Mul, Speedup, Non-SIMD Mul/Red, SIMD Mul/Red, Speedup\n");
    ...
    fprintf(stderr, "%5.2lf,", megaMults);
    ...
    fprintf(stderr, "%5.2lf,", megaMultAdds);
    mmn = megaMultAdds;
